...
export declare function ChartControls({ chartType, onChartTypeChange, indicators, onIndicatorsChange, patternsEnabled, onPatternsToggle, visiblePatterns, onVisiblePatternsChange, statsEnabled, onStatsToggle, activeDrawingTool, onActiveDrawingToolChange, hasDrawings, onDeleteAllDrawings, className, }: Props): JSX.Element;
