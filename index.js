...
function ce(e) {
	return Math.floor((e - se) / 2);
}
var le = 1440 * 60 * 1e3, ue = 365.25, de = 252;
function fe(e) {
	let t = e.length;
	if (t < 2) return 252;
	let n = Date.parse(e[0].date), r = Date.parse(e[t - 1].date);
	return !Number.isFinite(n) || !Number.isFinite(r) || r <= n ? 252 : ue / ((r - n) / le / (t - 1));
}
function pe(e, t) {
	let n = fe(e);
	return ee.map((e) => ({
		key: e,
		bars: Math.round(ne[e] * n)
	})).filter((e) => e.bars >= 30 && e.bars <= t);
}
function me(e) {
	return Math.max(10, ce(e));
}
function he(e, t) {
	return {
		minOffset: -(t - 1),
...
function ge(e, t, n) {
	let { minOffset: r, maxOffset: i } = he(t, n);
...
var ve = (e) => e == null ? "" : e.toLocaleString("en-IN", {
	minimumFractionDigits: 2,
	maximumFractionDigits: 2
}), ye = (e) => e == null ? "" : e >= 1e9 ? (e / 1e9).toFixed(2) + "B" : e >= 1e6 ? (e / 1e6).toFixed(2) + "M" : e >= 1e3 ? (e / 1e3).toFixed(0) + "K" : e.toString(), be = (e) => e == null ? "" : e >= 1e9 ? Math.round(e / 1e9) + "B" : e >= 1e6 ? Math.round(e / 1e6) + "M" : e >= 1e3 ? Math.round(e / 1e3) + "K" : e.toString(), xe = 1440 * 60 * 1e3;
function Se(e, t = 30, n = 365) {
	...
	let l = new Date(e[r - 1].date).getTime() - n * xe, u = -1, d = 0;
...
function Ae(e) {
	...
	let t = e;
	return t.v === 2 ? Me(t.ax) && Me(t.ay) && Me(t.dx) && Me(t.dy) ? e : null : t.v === void 0 && Me(t.x) && Me(t.y) ? e : null;
}
function je(e, t, n, r) {
	let i = Ee(e.x, e.y, t, n, r);
	return De(i.left, i.top, t, n, r);
}
function Me(e) {
...
function Ie(e, t) {
	...
	return new Date(n + t * Fe(e)).toISOString().slice(0, 10);
}
function Le(e, t) {
	if (e.length === 0) return 0;
	let n = Date.parse(e[e.length - 1].date), r = (Date.parse(t) - n) / Fe(e);
...
function ze(e, t) {
	...
	let r = Fe(e), i = t < 0 ? 0 : n, a = Date.parse(e[i].date) + (t - i) * r;
...
function N(e, t, n, r) {
	for (let i of r) {
		let r = t[i.key];
		r && Be(e, n, r, i.st, (e) => !Number.isNaN(r[e]));
	}
}
...
var Ke = [
	...
	warmupBars: () => 0,
	compute: (e) => ({ series: {
		high1y: Ge(e.bars, "high1y"),
		high2y: Ge(e.bars, "high2y"),
		high3y: Ge(e.bars, "high3y"),
		highAll: Ge(e.bars, "highAll")
	} }),
	draw: (e, t, n, r, i) => {
		for (let a of Ke) {
			let o = t[a.key];
			o && Be(e, n, o, F(r, a.key, i), (e) => I(a.key, e, t, n.data));
		}
	},
	autofitKeys: () => [
		"high1y",
	...
	legend: (e, t, n, r) => Ke.map((i) => ({
		color: String(n[`${i.key}Color`]),
		label: i.label,
		value: M(e[i.key], t, r.priceFmt)
	}))
}, Je = (e) => Math.round(e * 100) / 100;
function Ye(e, t) {
	...
	for (let t = 0; t < n; t++) {
		...
		a = Number.isNaN(a) ? n : i * n + (1 - i) * a, r[t] = Je(a);
	}
	return r;
}
function L(e, t) {
...
function Xe(e) {
	...
	for (let i = 0; i < t; i++) {
		...
		r = Number.isNaN(r) ? t : Math.max(r, t), n[i] = Je(r);
	}
	return n;
}
//#endregion
//#region src/indicators/builtins/rsLine.ts
var R = (e) => Math.round(e * 100) / 100, Ze = {
	key: "rs",
	label: "RS Line",
	...
	compute: (e, t) => {
		...
		for (let e = 0; e < n; e++) r[e] = Number.isNaN(o[e]) ? NaN : R(o[e] * c);
		let l = L(r, t.lookback), u = L(e.h, t.lookback);
		for (let t = 0; t < n; t++) {
	...
	draw: (e, t, n, r, i) => {
		...
		a && (Be(e, n, a, F(r, "line", i), (e) => !Number.isNaN(a[e])), o && P(e, n, a, {
	...
	draw: (e, t, n, r, i) => {
		let a = t.stage2;
		if (!a) return;
		let { xScale: o, bandwidth: s, renderStart: c, renderEnd: l } = n, u = Math.max(...n.yPrice.range()), d = u - Qe;
		e.save(), e.fillStyle = i(r.bandColor), e.globalAlpha = $e;
		let f = -1, p = (t) => {
			let n = o(f), r = o(t) + s;
			e.fillRect(n, d, r - n, Qe);
		};
...
var it = 40, at = 70, ot = 65, st = "500 10px 'Helvetica Neue', Helvetica, Arial, sans-serif", ct = 864e5, lt = 365 * ct, ut = 48, dt = (e) => e.toLocaleString("en-US", {
	minimumFractionDigits: 2,
	maximumFractionDigits: 2
}), ft = (e) => `${e >= 0 ? "+" : ""}${e.toFixed(1)}%`;
function pt(e, t) {
	let n = e[t] - lt, r = -1, i = Infinity;
	for (let t = 0; t < e.length; t++) {
		let a = Math.abs(e[t] - n) / ct;
		a <= it && a < i && (i = a, r = t);
	}
	return r;
}
...
function z(e) {
	let t = [...e.quarterlyResults ?? []].sort((e, t) => e.date < t.date ? -1 : +(e.date > t.date)), n = mt(t, "eps"), r = mt(t, "rps"), i = e.market === "US" ? "$" : "₹", a = t.map((e, t) => {
		let a = e.eps == null ? NaN : e.eps, o = e.rps == null ? NaN : e.rps, s = n[t], c = r[t];
		return {
			label: e.label,
			eps: a,
			rps: o,
			epsText: Number.isFinite(a) ? i + dt(a) : "--",
			rpsText: Number.isFinite(o) ? i + dt(o) : "--",
			epsGrowthText: Number.isNaN(s) ? "" : ft(s),
			rpsGrowthText: Number.isNaN(c) ? "" : ft(c),
			epsGrowthUp: s >= 0,
			rpsGrowthUp: c >= 0
		};
...
var _t = (e, t, n, r, i, a) => {
	...
	e.save(), e.beginPath(), e.rect(-1e6, f, 2e6, m), e.clip(), e.font = rt(i, "var(--font-weight-medium)", "var(--text-3xs)", st);
	let b = [];
	for (let e = u; e < d; e++) {
		let n = t.anchor[e];
	...
	if (s === "text") {
		...
		if (m >= ot) {
			...
			for (let n = 0; n < b.length; n++) {
				if (!t[n]) continue;
				let { x: o, row: s } = b[n];
				e.fillStyle = y, e.fillText(s.label, o, r), gt(e, o, i, [
					{
						text: "EPS",
						color: y
					},
	...
	let w = C * c.step(), T = Math.min(ut, w * .3), E = Math.min(4, T * .12), D = Math.max(1, (T - E) / 2), O = (t, r, i) => {
		if (!Number.isFinite(r)) return;
		let a = n.y(r), o = Math.min(x, a), s = Math.max(1, Math.abs(x - a));
		e.fillStyle = i, e.fillRect(t, o, D, s);
	}, ee = ht(b.map((e) => e.x), at);
	e.textAlign = "center";
...
}, xt = .5, St = 2, Ct = 9, wt = "600 9px 'Helvetica Neue', Helvetica, Arial, sans-serif";
function Tt(e, t) {
	let n = e.c.length, r = e.displayStart ?? 0, i = e.bars.slice(r), a = Se(i, t.smaPeriod), o = new Float64Array(n).fill(NaN), s = new Float64Array(n).fill(NaN), c = new Float64Array(n).fill(NaN), l = new Float64Array(n).fill(NaN);
...
var Et = {
	...
	draw: (e, t, n, r, i) => {
		...
		if (g) {
			e.fillStyle = m, e.font = rt(i, "var(--font-weight-semibold)", "var(--text-2hxs)", wt), e.textAlign = "center", e.textBaseline = "alphabetic";
			for (let t = s; t < c; t++) {
				let r = g[t];
				if (Number.isNaN(r)) continue;
				let i = l[t];
				if (!i) continue;
				let s = Math.max(n.y(i.volume) - St, u + Ct);
	...
	legend: (e, t, n) => [{
		color: n.upColor,
		label: "Vol",
		value: M(e.volumeUp, t, ye)
	}, {
		color: n.downColor,
		label: "Vol",
		value: M(e.volumeDown, t, ye)
	}]
}, B = (e) => Number.isNaN(e) ? NaN : Math.round(e * 100) / 100;
function V(e) {
...
function Ot(e, t) {
	let n = e.length, r = H(n), i = V(e), a = i + t - 1;
	if (t < 1 || a >= n) return r;
...
function kt(e, t) {
	return At(e, t, V(e) + t - 1);
}
function At(e, t, n) {
	let r = e.length, i = H(r);
...
function jt(e, t) {
	let n = e.length, r = kt(e, t), i = kt(r, t), a = H(n);
	for (let e = 0; e < n; e++) !Number.isNaN(r[e]) && !Number.isNaN(i[e]) && (a[e] = 2 * r[e] - i[e]);
	return a;
}
function Mt(e, t) {
	let n = e.length, r = kt(e, t), i = kt(r, t), a = kt(i, t), o = H(n);
	for (let e = 0; e < n; e++) Number.isNaN(a[e]) || (o[e] = 3 * r[e] - 3 * i[e] + a[e]);
	return o;
}
function Nt(e, t, n) {
	switch (e) {
		case 1: return kt(t, n);
		case 2: return Ot(t, n);
		case 3: return jt(t, n);
		case 4: return Mt(t, n);
		default: return Dt(t, n);
	}
}
function Pt(e, t) {
	switch (e) {
...
function Vt(e, t, n, r) {
	let i = e.length, a = H(i);
	if (r < 1 || r >= i) return a;
	let o = zt(e, t, n), s = H(i), c = H(i);
	for (let n = 1; n < i; n++) {
		let r = e[n] - e[n - 1], i = t[n - 1] - t[n];
		s[n] = r > i && r > 0 ? r : 0, c[n] = i > r && i > 0 ? i : 0;
	}
	let l = It(o, r, 1), u = It(s, r, 1), d = It(c, r, 1);
	for (let e = r; e < i; e++) {
...
function Ht(e, t, n, r) {
	return Ft(zt(e, t, n), r, 1);
}
function Ut(e, t, n, r) {
	return Ft(Vt(e, t, n, r), r, r);
}
function Wt(e, t, n, r) {
	let i = e.length, a = Lt(e, r), o = Rt(t, r), s = H(i);
	for (let e = 0; e < i; e++) {
...
var Kt = {
	...
	compute: (e, t) => {
		...
		for (let e = 0; e < n.length; e++) n[e] = B(n[e]);
		return { series: { sma: n } };
	},
	draw: (e, t, n, r, i) => N(e, t, n, [{
		key: "sma",
		st: F(r, "line", i)
	}]),
	autofitKeys: () => ["sma"],
...
var Jt = {
	...
	warmupBars: (e) => Math.max(Pt(e.matype, e.period), e.period - 1) + Math.max(250, 5 * e.period),
	compute: (e, t) => {
		let n = e.c.length, r = Nt(t.matype, e.c, t.period), i = Gt(e.c, t.period), a = new Float64Array(n), o = new Float64Array(n), s = new Float64Array(n);
		for (let e = 0; e < n; e++) {
			if (Number.isNaN(r[e]) || Number.isNaN(i[e])) {
				a[e] = NaN, o[e] = NaN, s[e] = NaN;
				continue;
			}
			o[e] = B(r[e]), a[e] = B(r[e] + t.nbdevup * i[e]), s[e] = B(r[e] - t.nbdevdn * i[e]);
		}
		return { series: {
			upperband: a,
			middleband: o,
	...
	legend: (e, t, n, r) => [
		{
			color: n.upperColor,
			label: "Upper",
			value: M(e.upperband, t, r.priceFmt)
		},
		{
			color: n.midColor,
			label: "Mid",
			value: M(e.middleband, t, r.priceFmt)
		},
		{
			color: n.lowerColor,
			label: "Lower",
			value: M(e.lowerband, t, r.priceFmt)
		}
	]
}, Qt = {
	key: "ti:rsi",
	...
	compute: (e, t) => {
		let n = e.c.length, r = At(e.c, t.fast, t.slow - 1), i = kt(e.c, t.slow), a = new Float64Array(n);
		a.fill(NaN);
		for (let e = 0; e < n; e++) !Number.isNaN(r[e]) && !Number.isNaN(i[e]) && (a[e] = r[e] - i[e]);
		let o = kt(a, t.signal), s = new Float64Array(n), c = new Float64Array(n), l = new Float64Array(n);
		for (let e = 0; e < n; e++) {
			if (Number.isNaN(o[e])) {
				s[e] = NaN, c[e] = NaN, l[e] = NaN;
				continue;
			}
			s[e] = B(a[e]), c[e] = B(o[e]), l[e] = B(a[e] - o[e]);
		}
		return { series: {
			macd: s,
			macdsignal: c,
	...
	draw: (e, t, n, r, i) => {
		t.macdhist && Ve(e, n, t.macdhist, {
			color: i(r.histUpColor),
			width: 1
		}, i(r.histDownColor)), N(e, t, n, [{
			key: "macd",
			st: F(r, "macd", i)
		}, {
			key: "macdsignal",
	...
	legend: (e, t, n) => [
		...
		},
		{
			...
			label: "Signal",
			value: M(e.macdsignal, t, j)
		},
		{
			color: n.histUpColor,
			label: "Hist",
			value: M(e.macdhist, t, j)
		}
	]
}, en = {
	key: "ti:stoch",
	...
	compute: (e, t) => {
		let n = Wt(e.h, e.l, e.c, t.fastk), r = Nt(t.slowk_matype, n, t.slowk), i = Nt(t.slowd_matype, r, t.slowd);
		for (let e = 0; e < r.length; e++) Number.isNaN(i[e]) && (r[e] = NaN), r[e] = B(r[e]), i[e] = B(i[e]);
		return { series: {
			slowk: r,
			slowd: i
		} };
	...
	compute: (e, t) => {
		let n = Wt(e.h, e.l, e.c, t.fastk), r = Nt(t.fastd_matype, n, t.fastd);
		for (let e = 0; e < n.length; e++) Number.isNaN(r[e]) && (n[e] = NaN), n[e] = B(n[e]), r[e] = B(r[e]);
		return { series: {
			fastk: n,
			fastd: r
		} };
	...
	compute: (e, t) => {
		let n = Bt(e.c, t.timeperiod), r = Wt(n, n, n, t.fastk), i = Nt(t.fastd_matype, r, t.fastd);
		for (let e = 0; e < r.length; e++) Number.isNaN(i[e]) && (r[e] = NaN), r[e] = B(r[e]), i[e] = B(i[e]);
		return { series: {
			fastk: r,
			fastd: i
	...
	warmupBars: (e) => e.period - 1 + Math.max(250, 5 * e.period),
	compute: (e, t) => {
		let n = e.c.length, r = Lt(e.h, t.period), i = Rt(e.l, t.period), a = new Float64Array(n);
		a.fill(NaN);
		for (let t = 0; t < n; t++) {
			if (Number.isNaN(r[t]) || Number.isNaN(i[t])) continue;
			let n = r[t] - i[t];
			a[t] = B(n === 0 ? 0 : -100 * (r[t] - e.c[t]) / n);
		}
	...
	warmupBars: (e) => e.period + Math.max(250, 5 * e.period),
	compute: (e, t) => {
		let n = e.c.length, r = Ht(e.h, e.l, e.c, t.period), i = new Float64Array(n);
		i.fill(NaN);
		for (let t = 0; t < n; t++) Number.isNaN(r[t]) || e.c[t] === 0 || (i[t] = B(100 * r[t] / e.c[t]));
...
function hn(e, t) {
	let n = W(e);
	if (!n) return;
	let r = { ...t?.settingsOverrides }, i = mn(n, r);
	return {
		id: t?.id ?? e,
		defKey: e,
		label: n.label,
...
function Sn(e, t, n, r) {
	return Math.hypot(e - n.x, t - n.y) <= bn ? {
		kind: "handle",
		index: 0
	} : Math.hypot(e - r.x, t - r.y) <= bn ? {
		kind: "handle",
		index: 1
	} : xn(e, t, n.x, n.y, r.x, r.y) <= 6 ? { kind: "body" } : null;
}
function Cn(e, t, n, r) {
...
function jn(e, t, n, r, i, a, o) {
	...
	for (let u = n - a; u <= n + a; u++) {
		...
		if (l && xn(e, t, s, c, a, d) <= o) return !0;
		s = a, c = d, l = !0;
	}
	return !1;
}
function Mn(e, t, n, r, i, a, o = 6) {
	if (!Number.isFinite(n) || r.length === 0) return null;
	let s = Math.max(1, Math.ceil(o / Math.max(a, 1e-6)));
	for (let c = r.length - 1; c >= 0; c--) {
		let l = r[c];
		if (l.interpolate ? jn(e, t, n, l, i, s, o) : An(e, t, n, l, i, a)) return l;
	}
	return null;
}
//#endregion
...
}, Ln = (e) => typeof e == "object" && !!e && !Array.isArray(e);
function Rn(e, t) {
	if (t === void 0) return e;
	if (!Ln(e) || !Ln(t)) return t;
	let n = { ...e };
	for (let r of Object.keys(t)) n[r] = Rn(e[r], t[r]);
	return n;
}
function zn(e) {
	return Rn(In, e);
...
function Vn(e) {
	...
	switch (t.type) {
		case "trendline":
		case "ray":
		case "ruler": return Bn(t.a) && Bn(t.b) ? e : null;
		case "hray":
		case "text": return Bn(t.a) ? e : null;
...
function Un(e) {
	return {
		color: e?.color ?? Hn.color,
		width: e?.width ?? Hn.width,
		style: e?.style ?? Hn.style,
		opacity: e?.opacity ?? Hn.opacity,
		text: e?.text ?? Hn.text,
		fontSize: e?.fontSize ?? Hn.fontSize,
		bgColor: e?.bgColor ?? Hn.bgColor,
		bgOpacity: e?.bgOpacity ?? Hn.bgOpacity
	};
}
//#endregion
...
function Jn() {
	!Wn || K.length > 0 || (document.removeEventListener("pointerdown", Gn, !0), document.removeEventListener("keydown", Kn, !1), Wn = !1);
}
function Yn(e) {
	return K.push(e), qn(), () => {
...
function $n({ chartType: e, onChartTypeChange: t, indicators: n, onIndicatorsChange: r, patternsEnabled: i, onPatternsToggle: a, visiblePatterns: o, onVisiblePatternsChange: l, statsEnabled: f, onStatsToggle: p, earningsEnabled: m, onEarningsToggle: h, className: g }) {
	...
	q(_, () => v(!1), [y]), q(b, () => x(!1), [S]);
	let C = (e) => o ? o.includes(e) : !0, w = o ? o.length : we.length, T = (e) => {
		if (!l) return;
		let t = o ?? we;
		l(t.includes(e) ? t.filter((t) => t !== e) : [...t, e]);
	}, E = fn().filter((e) => e.pane === "price").sort((e, t) => Xn(e.key, vn) - Xn(t.key, vn)), D = fn().filter((e) => typeof e.pane == "object").sort((e, t) => Xn(Zn(e), yn) - Xn(Zn(t), yn)), O = (e) => {
		let t = hn(e.key, {
			id: Qn(),
			enabled: !0
		});
	...
	return /* @__PURE__ */ d("div", {
		className: G(J.chartControls, g),
		children: [
			/* @__PURE__ */ d("div", {
				className: "pill-toggle-group",
				children: [/* @__PURE__ */ u("button", {
					className: G("pill-toggle-btn", "pill-toggle-btn-sm", e === "candlestick" && "is-active"),
					onClick: () => t("candlestick"),
					children: "Candles"
				}), /* @__PURE__ */ u("button", {
					className: G("pill-toggle-btn", "pill-toggle-btn-sm", e === "bar" && "is-active"),
					onClick: () => t("bar"),
					children: "Bars"
				})]
			}),
			/* @__PURE__ */ d("div", {
				...
				children: [/* @__PURE__ */ d("button", {
					type: "button",
					className: G("pill-toggle-btn", "pill-toggle-btn-sm", _ && "is-active"),
					onClick: () => v((e) => !e),
					children: [
						"Indicators ·",
						" ",
			...
			/* @__PURE__ */ d("div", {
				...
				children: [/* @__PURE__ */ d("button", {
					type: "button",
					className: G("pill-toggle-btn", "pill-toggle-btn-sm", i && "is-active"),
					onClick: () => x((e) => !e),
					children: [
						"Patterns ·",
						" ",
					...
					children: /* @__PURE__ */ d("div", {
						...
						children: [
							...
							Ce.map(({ name: e, label: t }) => /* @__PURE__ */ d("label", {
								className: J.pickerCheckRow,
								children: [/* @__PURE__ */ u("span", {
									className: J.pickerLabel,
									children: t
			...
			/* @__PURE__ */ d("div", {
				className: "pill-toggle-group",
				children: [/* @__PURE__ */ u("button", {
					className: G("pill-toggle-btn", "pill-toggle-btn-sm", f && "is-active"),
					onClick: p,
					children: "Stats"
				}), h && /* @__PURE__ */ u("button", {
					className: G("pill-toggle-btn", "pill-toggle-btn-sm", m && "is-active"),
					onClick: h,
					children: "Earnings"
				})]
			})
...
function er(e) {
	...
	return r ? `#${Y(r[1] * 255)}${Y(r[2] * 255)}${Y(r[3] * 255)}` : tt;
}
//#endregion
...
function nr({ spec: e, value: t, onCommit: n }) {
	...
	return /* @__PURE__ */ d("label", {
		className: A.legendPopoverField,
...
function ar({ label: e, colorExpr: t, isOverridden: n, resolveColor: r, onCommit: a, onReset: o }) {
	...
	return i(() => f(s), [s]), /* @__PURE__ */ d("div", {
		className: A.legendColorField,
		children: [/* @__PURE__ */ u("span", { children: e }), /* @__PURE__ */ d("div", {
			className: A.legendColorControls,
			children: [
				/* @__PURE__ */ u("input", {
					type: "color",
					value: s,
...
function dr(e) {
	let { appearance: t, onAppearanceChange: n, resolveColor: r } = e, i = zn(t), a = (e, r) => n(lr(t, e, r)), o = (e) => n(ur(t, e));
	return {
		eff: i,
		commit: a,
		reset: o,
...
function mr({ appearance: e, onAppearanceChange: t, resolveColor: n, onClose: r, triggerRef: i, style: a }) {
	...
	return /* @__PURE__ */ d("div", {
		className: A.settingsDialog,
		ref: o,
		style: a,
		"data-chart-wheel-scroll": !0,
		"data-chart-native-menu": !0,
		children: [/* @__PURE__ */ d("div", {
			className: A.legendPopoverHeader,
			children: [/* @__PURE__ */ u("span", {
				className: A.legendPopoverTitle,
				children: "Chart settings"
			}), /* @__PURE__ */ u("button", {
				type: "button",
				className: A.legendPopoverClose,
				title: "Close",
				onClick: r,
				children: "×"
			})]
		}), /* @__PURE__ */ d("div", {
			className: A.panelScrollBody,
			children: [
				/* @__PURE__ */ u("div", {
					className: A.settingsSectionTitle,
				...
				/* @__PURE__ */ u("div", {
					className: A.settingsGroupTitle,
					children: "Candles"
				}),
				/* @__PURE__ */ u(fr, { ...c }),
				/* @__PURE__ */ u("div", {
...
function gr({ visibleBars: e, onVisibleBarsChange: t, maxVisibleBars: n, marks: r, onPanReset: i }) {
	let a = Math.max(10, n), o = (r ?? ie).filter((e) => e.bars <= a), s = o.length ? Math.min(...o.map((e) => e.bars)) : Math.min(te["3M"], a), c = Math.max(s, Math.min(e, a)), l = Math.log(s), f = Math.log(a), p = f - l, m = (e) => p > 0 ? (Math.log(e) - l) / p * 100 : 0, h = (e) => {
...
function _r(e, t, n, r) {
	return e.map((e) => e.id === t ? hn(e.defKey, {
		id: e.id,
		enabled: e.enabled,
		settingsOverrides: {
			...e.settingsOverrides,
		...
		children: [/* @__PURE__ */ d("div", {
			...
			children: [/* @__PURE__ */ d("span", {
				...
				children: [t.longLabel ?? t.label, m && /* @__PURE__ */ u("span", {
					className: A.legendPopoverSummary,
					children: m
				})]
			}), /* @__PURE__ */ u("button", {
				type: "button",
...
function br({ configs: e, top: t, left: n, openId: r, setOpenId: i, onCommit: a, onReset: o, onResetKeys: c, resolveColor: l, onRemove: f, rowsFor: h, toggle: g }) {
	...
	return /* @__PURE__ */ d("div", {
		...
		children: [e.map((e) => {
			let t = W(e.defKey);
			if (!t) return null;
			let n = (t.settingsSchema?.length ?? 0) > 0, s = _n(e), p = h(e), m = p[0]?.color ? v(p[0].color) : "transparent", g = p.filter((e) => e.value).map((e) => ({
				text: e.value,
				color: v(e.color)
			}));
			return /* @__PURE__ */ d("div", {
				className: A.legendItem,
				children: [
					/* @__PURE__ */ u("span", {
						className: A.legendDot,
						style: { background: m }
					}),
					/* @__PURE__ */ d("span", {
						className: A.legendLabel,
						children: [t.label, s ? ` ${s}` : ""]
					}),
					g.length > 0 && /* @__PURE__ */ u("span", {
						className: A.legendValues,
...
function xr({ indicators: e, onIndicatorsChange: t, resolved: n, subpanes: r, marginTop: a, marginLeft: o, infoBarHeight: s, barCount: l, expanded: f, onExpandedChange: p, subscribeHoverIndex: m, priceFormatter: h, resolveColor: g }) {
	...
	}, E = e.filter((e) => e.enabled), D = E.filter((e) => W(e.defKey)?.pane === "price"), O = (e) => E.filter((t) => {
		let n = W(t.defKey)?.pane;
		return typeof n == "object" && n.subpane === e;
	}), ee = b ?? l - 1, te = (e) => {
		if (ee < 0) return [];
		let t = n.find((t) => t.config.id === e.id), r = W(e.defKey);
		return !t || !r ? [] : r.legend(t.series, ee, e.settings, { priceFmt: h });
	};
	return /* @__PURE__ */ d("div", {
		className: A.legend,
		"data-chart-legend": "",
	...
	return /* @__PURE__ */ d("div", {
		...
		children: [/* @__PURE__ */ d("div", {
			...
			children: e.length === 0 ? /* @__PURE__ */ u("div", {
				className: A.autoFitMenuEmpty,
				children: "No overlays to fit"
			}) : e.map((e) => /* @__PURE__ */ d("label", {
				className: A.autoFitMenuRow,
				children: [/* @__PURE__ */ u("input", {
					type: "checkbox",
...
function wr(e) {
	...
	let S = r && !("v" in r) ? r : null, C = p || (r && "v" in r ? r : S ? d ? je(S, t, d.panelW, d.panelH) : null : o), w = null;
	if (d && C) if (_ && h) w = h;
	else {
		let e = Te(C, t, d.panelW, d.panelH);
		w = Ee(e.left, e.top, t, d.panelW, d.panelH);
	}
	return i(() => {
		!S || !d || b.current !== S && (b.current = S, a?.(je(S, t, d.panelW, d.panelH)));
	}, [
		S,
		d,
		t,
		...
		handlers: {
			...
			onPointerMove: (e) => {
				let n = y.current;
				!n || e.pointerId !== n.pointerId || (e.stopPropagation(), d && g(Ee(n.startX + (e.clientX - n.mx), n.startY + (e.clientY - n.my), t, d.panelW, d.panelH)));
			},
			onPointerUp: (e) => {
				let n = y.current;
				if (!n || e.pointerId !== n.pointerId || (e.stopPropagation(), !d)) return;
				let r = Ee(n.startX + (e.clientX - n.mx), n.startY + (e.clientY - n.my), t, d.panelW, d.panelH), i = De(r.left, r.top, t, d.panelW, d.panelH);
				a?.(i), m(i), g(null), y.current = null, v(!1), l.current?.releasePointerCapture(e.pointerId);
			},
			onPointerCancel: (e) => {
				let n = y.current;
				!n || e.pointerId !== n.pointerId || (e.stopPropagation(), h && d && m(De(h.left, h.top, t, d.panelW, d.panelH)), g(null), y.current = null, v(!1), l.current?.releasePointerCapture(e.pointerId));
			}
		}
	};
}
...
function Er(e) {
	...
	return q(m, y, [v, _]), i(() => {
		...
		children: /* @__PURE__ */ d("div", {
			...
			className: G(X.card, r && X.dragging),
			style: n ? {
				left: n.left,
				top: n.top
			} : { visibility: "hidden" },
			...
			children: [
				...
				Tr.map(({ tool: t, label: n, Icon: r }) => /* @__PURE__ */ u("button", {
					...
					className: G(X.toolBtn, e.activeTool === t && X.toolBtnActive),
				...
				e.onDeleteAll && /* @__PURE__ */ d(l, { children: [/* @__PURE__ */ u("div", { className: X.divider }), /* @__PURE__ */ d("div", {
					...
					children: [/* @__PURE__ */ u("button", {
						...
						"aria-expanded": m,
						className: G(X.toolBtn, m && X.toolBtnActive),
...
function Rr(e, t, n, r = Nr) {
	let i = e.length;
	if (i === 0) return { rows: [] };
	let { h: a, l: o, c: s } = jr(e), c = s[i - 1], l = i >= 2 ? s[i - 2] : s[i - 1], u = Number.isFinite(r) && r > 0 ? r : Nr, d = (e) => Math.max(1, Math.round(u * e)), f = Math.sqrt(Nr / u), p = zt(a, o, s), m = new Float64Array(i);
	for (let e = 0; e < i; e++) m[e] = p[e] / s[e];
	let h = Lr(Dt(m, d(1 / 2)), f), g = Lr(Dt(m, d(1 / 4)), f), _ = Lr(Dt(m, d(1 / 12)), f), v = t ?? {}, y = (v.sector ?? "").trim(), b = (v.industry ?? "").trim(), x = Fr(v.sharesOutstanding), S = Fr(v.freeFloatPercent), C = Mr;
	if (S !== null) {
...
function oi(e, t) {
	...
	let a = r.map((e) => new Date(e.date).getTime()), o = r.map((e) => Qr(e.eps)), s = r.map((e) => Qr(e.rps)), c = r.map((e) => Qr(e.npm)), l = mt(r, "eps"), u = mt(r, "rps"), d = new Float64Array(i).fill(NaN);
	for (let e = 0; e < i; e++) {
		let t = c[e];
	...
	for (let e = i - 1; e >= Math.max(0, i - Yr); e--) {
		let t = pt(a, e), n = t >= 0 ? o[t] : NaN, i = t >= 0 ? s[t] : NaN;
		f.push({
			label: $r(r[e].date),
			cells: [
				ti(o, e),
...
function Ai(e, t, n) {
	...
	let p = Math.max(1, Math.round(f * t.hRatio)), m = Math.min(p, Math.max(Math.max(1, Math.floor(t.hRatio)), Math.round(p * Fn))), h = [], g = [];
...
function Ri(e) {
	return Fi(e.step, e.hRatio, Nn, Pn);
}
function zi(e, t, n) {
...
function Gi(e, t, n, r) {
	...
	for (let e of i.levels) {
		let n = k(r.bars, e.start), i = k(r.bars, e.end);
...
function Yi(e, t, n, r) {
	...
	let a = r.patternStyle.consolidation, o = r.resolveColor, s = a.labelFontSize, c = k(r.bars, i.start_date), l = k(r.bars, i.end_date);
...
function $i(e, t, n, r) {
	...
	let a = r.patternStyle.high_tight_flag, o = r.resolveColor, s = a.labelFontSize, c = k(r.bars, i.segments.pole[0]), l = k(r.bars, i.segments.pole[1]), u = k(r.bars, i.segments.flag[0]), d = k(r.bars, i.segments.flag[1]);
	...
	let O = i.score, ee = O != null && Number.isFinite(O) ? ` ${Math.round(O)}%` : "", te = i.tier === "high" ? "High" : i.tier === "low" ? "Low" : null, ne = `${te ? `${te} tight flag` : "Tight flag"}${ee}`, re = (Qi(r.dataLength - 1, r) ?? C) + r.bandwidth + 2 * r.step + 4, ie = n.append("g").attr("class", "htf-label").attr("transform", `translate(${re},${w})`), ae = s + 2 * Zi, oe = ie.append("text").attr("class", "htf-label-text").attr("x", Xi).attr("y", ae / 2).attr("dominant-baseline", "central").attr("font-size", s).attr("fill", o(a.labelTextColor)).style("font-weight", "var(--font-weight-semibold)").text(ne).node(), se = (oe ? oe.getBBox().width : ne.length * 7) + 2 * Xi;
	ie.insert("rect", "text").attr("class", "htf-label-bg").attr("x", 0).attr("y", 0).attr("width", se).attr("height", ae).attr("rx", 3).attr("fill", o(a.labelBg)).attr("fill-opacity", a.labelBgOpacity);
}
var ea = (e) => e + 8;
function ta(e, t) {
	if (t.dataLength === 0) return null;
...
function aa(e, t, n, r) {
	...
	let a = r.patternStyle.gap_up, o = r.resolveColor, s = k(r.bars, i.gap_date);
	if (s == null) return;
	let c = ta(s, r);
	if (c == null) return;
...
function sa(e, t, n, r) {
	...
	let a = r.patternStyle.volume_breakout, o = r.resolveColor, s = k(r.bars, i.event_date);
	if (s == null) return;
	let c = ta(s, r);
	if (c == null) return;
...
function ca(e, t, n, r) {
	...
	let a = r.patternStyle.golden_cross, o = r.resolveColor, s = k(r.bars, i.cross_date);
	if (s == null) return;
	let c = ta(s, r);
	if (c == null) return;
...
function ua(e, t, n, r) {
	...
	let a = r.patternStyle.nr7, o = r.resolveColor, s = k(r.bars, i.event_date);
	if (s == null) return;
	let c = ta(s, r);
	if (c == null) return;
...
function fa(e, t, n, r) {
	let i = e.markers;
	if (!i?.event_date || !Number.isFinite(i.anchor_low)) return;
	let a = r.patternStyle.unusual_volume, o = r.resolveColor, s = k(r.bars, i.event_date);
	if (s == null) return;
	let c = ta(s, r);
	if (c == null) return;
...
function ma(e, t, n, r) {
	let i = e.markers;
	if (!i?.event_date || !Number.isFinite(i.anchor_low)) return;
	let a = r.patternStyle.volume_dryup, o = r.resolveColor, s = k(r.bars, i.event_date);
	if (s == null) return;
	let c = ta(s, r);
	if (c == null) return;
...
function ga(e, t, n, r) {
	let i = e.markers;
	if (!i?.event_date || !Number.isFinite(i.anchor_low)) return;
	let a = r.patternStyle.pocket_pivot, o = r.resolveColor, s = k(r.bars, i.event_date);
	if (s == null) return;
	let c = ta(s, r);
	if (c == null) return;
...
function _a(e, t, n, r) {
	...
	let a = r.patternStyle.inside_day, o = r.resolveColor, s = k(r.bars, i.mother_date), c = k(r.bars, i.inside_date);
...
function va(e, t, n, r) {
	...
	let a = r.patternStyle.pullback_to_ema, o = r.resolveColor, s = k(r.bars, i.event_date);
	if (s == null) return;
	let c = ta(s, r);
	if (c == null) return;
...
function Ea(e, t) {
	...
	let n = k(t.data, e);
	return n == null ? e < t.data[0].date ? (t.xScale(0) ?? 0) + t.bandwidth / 2 : (t.xScale(t.dataLength - 1) ?? 0) + t.bandwidth / 2 + Le(t.data, e) * t.step : (t.xScale(n) ?? 0) + t.bandwidth / 2;
}
function Da(e, t) {
	let n = t.yPrice(e);
...
function Ma(e, t) {
	return k(e, t) ?? (e.length > 0 && t > e[e.length - 1].date ? e.length - 1 + Le(e, t) : null);
}
var Na = 864e5;
function Pa(e, t, n) {
...
function Fa(e, t, n) {
	return t?.color === void 0 ? n(e.direction === "up" ? "var(--chart-positive)" : e.direction === "down" ? "var(--chart-negative)" : Hn.color) : n(t.color);
}
//#endregion
...
function Ha(e, t, n) {
	...
	return (e, t, n) => {
		...
		return s && s.kind === "handle" ? s : xn(r, t, i.x, i.y, o.x2, o.y2) <= 6 ? { kind: "body" } : null;
	};
}
//#endregion
...
function Wa(e, t, n) {
	...
	return Ba(a, r, n.resolveColor), n.selected && a.attr("stroke-width", r.width + 1.5), (e, t, r) => wn(e - r, t, i, n.s.priceHeight);
}
//#endregion
//#region src/drawings/renderers/hray.ts
function Ga(e, t, n) {
	let r = La(e), i = Aa(e.a, n.s), a = i.x + Math.max(n.s.width * 3, (n.s.dataLength + 50) * n.s.step);
	return Ba(t.pan.append("line").attr("x1", i.x).attr("y1", i.y).attr("x2", a).attr("y2", i.y), r, n.resolveColor), n.selected && Ra(t.label, i.x, i.y, n.resolveColor(r.color), n.resolveColor("var(--chart-drawing-handle)")), (e, t, n) => En(e - n, t, i, {
		x: a,
		y: i.y
	});
}
...
function qa(e, t, n) {
	...
	return (e, t, n) => {
		let r = Sn(e - n, t, i, a);
		return r && r.kind === "handle" ? r : Tn(e - n, t, D, 6);
	};
}
var Ja = (e) => e * 10;
function Ya(e, t, n) {
...
function no({ shape: e, onChange: t, onDelete: n, resolveColor: r, onClose: i, className: a, style: o }) {
	let c = s(null), f = Un(e.style), p = e.type === "text";
	q(!0, i, [c]);
	let m = (n) => t({
		...e,
		style: {
...
function ao({ shape: e, scaleApi: t, buildProjScale: r, marginLeft: o, marginTop: l, resolveColor: d, onCommit: f, onDeleteEmpty: p }) {
	let m = s(null), h = s(null), g = Un(e.style), [_, v] = c(e.style?.text ?? ""), y = n(() => {
		let n = m.current;
		if (!n) return;
		let i = Aa(e.a, r());
...
var $ = {
	...
	bottom: 30,
	left: 0
}, vo = 72, yo = 0, bo = "var(--font-family-base)", xo = 18, So = 8, Co = .13, wo = .45, To = 24, Eo = .08, Do = 18, Oo = 12, ko = "var(--chart-separator)", Ao = 56, jo = 10, Mo = "var(--chart-tooltip-label)", No = O.format(",.0f"), Po = 1.04, Fo = 4, Io = 700, Lo = (e) => e.pointerType;
function Ro(e, t, n) {
	switch (e.type) {
		case "trendline":
		case "ray":
...
var Vo = e.memo(({ data: e, warmupSeed: t, benchmarkClose: r, quarterlyResults: p, subpaneHeights: m = null, onSubpaneHeightsChange: h, visibleBars: g, onVisibleBarsChange: _, onMaxVisibleBarsChange: y, onRangeMarksChange: b, panOffset: S, onPanOffsetChange: w, chartType: T, indicators: E, onIndicatorsChange: D, autoFitMode: ee, onAutoFitModeChange: te, autoFitExcluded: ne, onAutoFitExcludedChange: re, infoBarExpanded: ie, onInfoBarExpandedChange: ae, symbol: oe, bare: se, width: ce, height: le, priceFormatter: ue, patterns: de, patternsEnabled: be, visiblePatterns: xe, statsTable: Se, statsEnabled: Ce, statsMarket: we = "India", statsPosition: Te = null, onStatsPositionChange: Ee, statsSize: De = "small", earningsEnabled: Oe, earningsResults: ke, earningsFreeFloatPercent: je, earningsPosition: Me = null, onEarningsPositionChange: k, appearance: Pe, onAppearanceChange: Fe, drawings: Ie, onDrawingsChange: Le, activeDrawingTool: Re = "cursor", onActiveDrawingToolChange: ze, drawToolbarEnabled: j = !1, drawToolbarPosition: M = null, onDrawToolbarPositionChange: Be, onContextMenu: N, children: Ve }) => {
	let P = s(null), He = s(null), Ue = s(null), We = s(null), F = s(null), Ge = s({
		cssWidth: 0,
		cssHeight: 0,
		suggested: null
	}), I = s(null), [Ke, qe] = c(0), [Je, Ye] = c(0), L = ce ?? Ke;
	a(() => {
		let e = He.current;
		if (!e) return;
		let t = e.getBoundingClientRect();
		t.width && qe(t.width), t.height && Ye(t.height);
	}, []);
	let Xe = e?.length ?? 0, R = o(() => zn(Pe), [Pe]), Ze = o(() => JSON.stringify(R.colors), [R]), Qe = o(() => JSON.stringify(R.background), [R]), $e = o(() => JSON.stringify(R.candle), [R]), et = o(() => JSON.stringify(R.axis), [R]), tt = o(() => JSON.stringify(R.crosshair), [R]), rt = o(() => JSON.stringify(R.patterns), [R]), [it, at] = c(0), [ot, st] = c(!1), ct = s(null), [lt, ut] = c(null), dt = n((e) => {
		st(!1), ut(e);
	}, []), ft = n(() => ut(null), []), pt = s(dt);
	pt.current = dt;
	let mt = s(!1);
	mt.current = Fe != null;
	let ht = s(null);
	ht.current ||= oo();
	let z = ht.current.api, gt = ht.current.notify, _t = ue ?? No, vt = s(_t);
	i(() => {
		vt.current = _t;
	}, [_t]);
	let yt = o(() => Xe > 0 ? O.range(Xe) : [], [Xe]), bt = o(() => {
		...
		let t = yn.filter((t) => e.has(t)), n = [...e].filter((e) => !yn.includes(e));
		return t.concat(n);
	}, [E]), [xt, St] = c(m);
	i(() => {
		St(m);
	...
	let Ct = o(() => {
		...
		for (let t of E) {
			if (!t.enabled) continue;
			let n = W(t.defKey), r = n?.pane;
			if (!r || typeof r != "object" || !("subpane" in r)) continue;
			let i = n?.paneHeightFactor ?? 1;
			e[r.subpane] = Math.max(e[r.subpane] ?? 1, i);
		}
		return e;
	}, [E]), wt = o(() => fe(e ?? []), [e]), Tt = o(() => pe(e ?? [], e?.length ?? 0), [e]), Et = o(() => me(L), [L]), B = Math.max(10, Math.min(g, Et)), V = o(() => {
		let t = _i({
			propWidth: ce,
			propHeight: le,
			measuredWidth: Ke,
		...
		let n = t.totalHeight, r = ge(S, e.length, B), i = Math.max(0, Math.floor(e.length - B - r)), a = Math.min(e.length, Math.ceil(e.length - r)), o = e.slice(i, a);
		if (o.length === 0) return null;
		let s = Math.ceil(B), c = Math.max(0, i - s), l = Math.min(e.length, a + s), u = e.slice(c, l), { priceHeight: d, subpanes: f, fullHeight: p } = si({
			totalHeight: n,
			subpaneKeys: bt,
			heightRatio: Co,
			floorRatio: wo,
			heightFactors: Ct,
			userHeights: xt ?? void 0
		}), m = t.width, h = (m - Do) / B, g = (r + B - e.length) * h, _ = O.scaleBand().domain(yt).range([0, h * Math.max(1, e.length - .3)]).paddingInner(.3).paddingOuter(0);
		return {
			totalHeight: n,
			visStart: i,
			visEnd: a,
			...
			visibleStartIdx: Math.round(e.length - B - r),
			effectiveOffset: r
		};
	}, [
		e,
		...
		p && (o.quarterlyResults = p), o.market = we;
		let s = i.length;
		...
		p,
		we
	]), Dt = o(() => !e || e.length === 0 ? null : Rr(t && t.length ? t.concat(e) : e, Se, we, wt), [
		e,
		t,
		Se,
		we,
		wt
	]), Ot = o(() => oi(ke, je), [ke, je]), kt = s(null), At = s([]), jt = n(() => {
		let e = We.current, t = F.current, n = Ge.current;
		...
		let e = F.current, t = kt.current;
		!e || !t || (jt(), At.current = Ti(e.ctx, {
			hRatio: e.hRatio,
			vRatio: e.vRatio,
			cssWidth: t.cssWidth,
			...
			resolveColor: (e, t) => I.current?.resolve(e, t) ?? "#888888"
		}));
	}, [z, jt]), Nt = o(() => V ? $.top + V.priceHeight : 0, [V]), Pt = s(null), Ft = n((e) => (t) => {
		V && (t.button !== 0 || t.ctrlKey || (t.preventDefault(), t.stopPropagation(), t.currentTarget.setPointerCapture(t.pointerId), Pt.current = {
			index: e,
			startY: t.clientY,
			bands: V.subpanes,
		...
		let t = Pt.current;
		t && (e.currentTarget.releasePointerCapture?.(e.pointerId), Pt.current = null, t.latest && h?.(t.latest));
	}, [h]), Rt = n((e) => {
		let t = Pt.current;
		t && (e.currentTarget.releasePointerCapture?.(e.pointerId), Pt.current = null, St(t.prev));
	}, []), [zt, Bt] = c(null), Vt = s(zt);
	i(() => {
		Vt.current = zt;
	}, [zt]);
	let Ht = zt === null, [Ut, Wt] = c(!1), [Gt, Kt] = c(!1), [qt, Jt] = c(!1), Yt = s(null), Xt = Ut || Gt || qt, U = s({ kind: "idle" }), Zt = s(/* @__PURE__ */ new Map()), Qt = () => U.current.kind !== "idle" || J.current.phase !== "idle", $t = s(w);
	i(() => {
		$t.current = w;
	}, [w]);
	let en = s(S);
	...
	let on = s(null), sn = s(0), cn = s(0), ln = s(null), un = s(0), dn = () => U.current.kind === "pan" && U.current.phase === "dragging", fn = s(null), pn = s(null), mn = s(null), hn = s(null), gn = s(null), _n = s(null), vn = s(null), bn = s(null), xn = s(null), Sn = s(null), Cn = s(null), wn = s(null), Tn = s(null), En = s(null), Dn = s(null), On = s([]), kn = s(null), An = s(null), jn = s(null), Nn = s(null), Pn = s(null), Fn = s(null), In = s(null), Ln = s(null), Rn = s(null), Bn = s(0), Hn = s(null), Un = s(null), G = s(null), K = s(null), Wn = s(/* @__PURE__ */ new Set()), Gn = n((e) => (Wn.current.add(e), () => {
		Wn.current.delete(e);
	}), []), Kn = s(null), qn = s(null), Jn = s(null), Yn = s(null), q = s(Re);
	i(() => {
		q.current = Re;
	}, [Re]);
	...
	let sr = s({
		fullHeight: 0,
		bands: []
	}), cr = o(() => (Ie ?? []).map(Vn).filter((e) => e !== null), [Ie]), lr = s(cr);
	lr.current = cr;
	let ur = o(() => Ae(Te), [Te]), dr = o(() => {
		let e = Ae(Me);
		...
		J.current = o.draft, o.selectId !== void 0 && Y(o.selectId), o.draft.phase === "dragging" && i.locked !== !0 && (U.current = {
			kind: "drawingDrag",
			phase: "armed",
			pointerId: r,
			id: i.id,
			...
			startMy: n,
			origin: i
		}, rr.current = lr.current.slice(), P.current && (P.current.style.cursor = "grabbing")), gr();
	}, [
		hr,
		Y,
		gr
	]), Dr = o(() => lt?.kind === "drawing" ? cr.find((e) => e.id === lt.id) ?? null : null, [lt, cr]), Or = o(() => lt?.kind === "indicator" ? E.find((e) => e.id === lt.id) ?? null : null, [lt, E]), Ar = o(() => {
		if (!er) return null;
	...
	i(() => {
		...
		let e = (e) => {
			if (e.key === "Escape") {
				(J.current.phase !== "idle" || U.current.kind === "drawingDrag" || Xn.current) && (J.current = Ta(J.current, { type: "escape" }, {
					tool: q.current,
					makeId: wr
				}).draft, Xn.current = null, U.current.kind === "drawingDrag" && (U.current = { kind: "idle" }), rr.current = null, gr());
				return;
			}
		...
		let e = (e) => {
			e.key !== "ArrowUp" && e.key !== "ArrowDown" && e.key !== "ArrowLeft" && e.key !== "ArrowRight" || (G.current != null && (cancelAnimationFrame(G.current), G.current = null), K.current = null, jn.current?.(), P.current && (P.current.style.cursor = "none"));
		};
		return document.addEventListener("keydown", e), () => document.removeEventListener("keydown", e);
	}, []);
	let [Pr, Fr] = c(null), [Ir, Lr] = c(null), [Q, zr] = c(null), [Br, Vr] = c(null), Hr = n((e, t) => {
		...
		let e = [], t = [];
		return Q && !ne.includes("trade") && (e.push(Q.min), t.push(Q.max)), Br && !ne.includes("trigger") && (e.push(Br.min), t.push(Br.max)), e.length === 0 ? null : {
			min: Math.min(...e),
			max: Math.max(...t)
		};
	}, [
	...
	i(() => {
		...
		let t = 0, n = new ResizeObserver((e) => {
			...
			n && (t && cancelAnimationFrame(t), t = requestAnimationFrame(() => {
				n.width && qe(n.width), n.height && Ye(n.height);
			}));
		});
		return n.observe(e), () => {
	...
	i(() => {
		...
		let r = nt(e);
		return I.current?.destroy(), I.current = r, at((e) => e + 1), () => {
			for (let t of n) e.style.removeProperty(`--${t}`);
			r.destroy(), I.current = null;
		};
	}, [Ze]);
	let Xr = V?.totalHeight ?? null;
	i(() => {
		let e = We.current;
		if (!e || Xr == null || L === 0) return;
		let t = L, n = Xr + $.top + $.bottom;
		e.style.width = `${t}px`, e.style.height = `${n}px`;
		let r = e.getContext("2d");
		if (!r) return;
		(!F.current || F.current.ctx !== r) && (F.current = {
			ctx: r,
			hRatio: 1,
			vRatio: 1
		});
	...
	let Zr = s(1), Qr = s(null), $r = n((e) => {
		nn.current && (Zr.current *= e, Qr.current ??= requestAnimationFrame(() => {
			Qr.current = null;
			let e = Zr.current;
			Zr.current = 1, nn.current?.((t) => Math.min(tn.current, Math.max(10, t * e)));
		}));
	}, []);
	i(() => {
		let e = P.current;
		if (!e || !_) return;
		function t(e) {
			e.target?.closest?.("[data-chart-wheel-scroll]") || (e.preventDefault(), $r(e.deltaY > 0 ? Po : 1 / Po));
		}
		...
		let t = (e) => {
			...
			e.preventDefault();
			let t = pn.current, [n, r] = t ? O.pointer(e, t.node()) : [0, 0], i = ui({
				mx: n,
				my: r,
				width: z.width,
				priceHeight: z.priceHeight,
			...
			if (i.kind === "price" || i.kind === "subpane") {
				let e = Math.floor(n / z.step), t = z.visibleStartIdx + e;
				e >= 0 && t >= 0 && t < z.data.length && (a = t, o = Ne(z.data, t));
			}
			if (i.kind === "price") s = z.yPrice.invert(r);
			else if (i.kind === "subpane") {
				let e = z.subpaneScales.get(i.key);
				e && (c = e.invert(r));
			}
			or.current({
				clientX: e.clientX,
		...
		let t = e?.length ?? 0;
		t !== 0 && $t.current((e) => ge(e, t, g));
	}, [e?.length, g]), i(() => {
		L === 0 || !_ || (g > Et || g < 10) && nn.current?.((e) => Math.min(Et, Math.max(10, e)));
	}, [
		Et,
		g,
		L,
	...
	let [ei, ti] = c(oe);
	ei !== oe && (ti(oe), zt !== null && Bt(null));
	let ni = n((e) => {
		if (!(e < 0)) for (let t of [Ln.current, Rn.current]) try {
			t?.node()?.releasePointerCapture?.(e);
		} catch {}
	}, []), ri = n((e, t, n) => {
		let r = Vt.current, i = r !== null, a = 0, o = 0, s = 1, c = 0;
		return i && r && (a = Math.log(r[0]), o = Math.log(r[1]), s = z.priceHeight / (o - a), c = (o - a) * 3), {
			kind: "pan",
			phase: "armed",
			pointerId: e,
			startX: t,
			startOffset: ge(en.current, z.data.length, z.visibleBars),
			baseTx: z.baseTranslateX,
			step: z.step,
			...he(z.data.length, z.visibleBars),
			startY: n,
			panY: i,
			startLoLog: a,
			startHiLog: o,
		...
		U.current = { kind: "idle" }, on.current != null && (cancelAnimationFrame(on.current), on.current = null), sn.current = 0, cn.current = 0, P.current && (P.current.style.cursor = ""), t && (fn.current && fn.current.setAttribute("transform", `translate(${e.baseTx},0)`), z.baseTranslateX = e.baseTx, gt("pan"), qn.current?.setTransform(e.baseTx), Yn.current?.setTransform(e.baseTx), e.panY && Bt([Math.exp(e.startLoLog), Math.exp(e.startHiLog)]), Mt());
	}, [
		z,
		gt,
		Mt,
	...
	i(() => {
		let e = () => {
			...
			P.current && (P.current.style.cursor = ""), on.current != null && (cancelAnimationFrame(on.current), on.current = null), U.current = { kind: "idle" };
			let t = Math.round(sn.current / e.step), n = Math.max(e.minOffset, Math.min(e.maxOffset, e.startOffset + t));
			sn.current = 0, n === e.startOffset ? fn.current && (fn.current.setAttribute("transform", `translate(${e.baseTx},0)`), z.baseTranslateX = e.baseTx, gt("pan"), qn.current?.setTransform(e.baseTx), Yn.current?.setTransform(e.baseTx), Mt()) : $t.current(n);
		}, t = (e) => {
			let t = U.current;
			if (t.kind !== "pan") return;
			if (t.phase === "armed") {
				if (Math.hypot(e.clientX - t.startX, e.clientY - t.startY) < pi(Lo(e))) return;
				t.phase = "dragging", G.current != null && (cancelAnimationFrame(G.current), G.current = null), K.current = null, jn.current?.(), P.current && (P.current.style.cursor = "grabbing");
			}
			let n = e.clientX - t.startX, r = _e(n, t.startOffset, t.minOffset, t.maxOffset, t.step);
			r !== n && (t.startX += n - r), sn.current = r, t.panY && (cn.current = e.clientY - t.startY), on.current ??= requestAnimationFrame(() => {
				on.current = null;
				let e = t.baseTx + sn.current;
				if (fn.current && fn.current.setAttribute("transform", `translate(${e},0)`), z.baseTranslateX = e, gt("pan"), qn.current?.setTransform(e), Yn.current?.setTransform(e), Mt(), t.panY) {
					let e = cn.current / t.pxPerLog;
					e = Math.max(-t.panCapLog, Math.min(t.panCapLog, e)), Bt([Math.exp(t.startLoLog + e), Math.exp(t.startHiLog + e)]);
				}
			});
		}, n = (e) => {
			let t = pn.current;
			...
			if (n.phase === "armed") {
				if (Math.hypot(r - n.startMx, i - n.startMy) < pi(Lo(e))) return;
				n.phase = "dragging";
			}
			let a = pr(), o = n.grab && n.grab.kind === "handle" ? Ro(n.origin, n.grab.index, hr(r, i)) : Bo(n.origin, r - n.startMx, i - n.startMy, a);
			...
			J.current = r.draft, rr.current = null, P.current && (P.current.style.cursor = ""), t && r.commit && br(r.commit), gr();
		}, a = () => {
			U.current.kind === "drawingDrag" && (U.current = { kind: "idle" }, J.current = Ta(J.current, { type: "escape" }, {
				tool: "cursor",
				makeId: wr
			}).draft, rr.current = null, P.current && (P.current.style.cursor = ""), gr());
		}, o = () => {
			ln.current = null;
			let e = U.current;
			if (e.kind !== "yAxis") return;
			let t = Math.exp(-un.current / 200), n = (e.startLoLog + e.startHiLog) / 2, r = Math.max(.002, Math.min(4, (e.startHiLog - e.startLoLog) / 2 / t));
			Bt([Math.exp(n - r), Math.exp(n + r)]);
		}, s = (e) => {
			let t = U.current;
			t.kind === "yAxis" && (un.current = e.clientY - t.startY, ln.current ??= requestAnimationFrame(o));
		}, c = () => {
			U.current.kind === "yAxis" && (U.current = { kind: "idle" }, P.current && (P.current.style.cursor = ""), ln.current != null && (cancelAnimationFrame(ln.current), ln.current = null));
		}, l = () => {
			let e = U.current;
			e.kind === "yAxis" && (U.current = { kind: "idle" }, P.current && (P.current.style.cursor = ""), ln.current != null && (cancelAnimationFrame(ln.current), ln.current = null), Bt(e.priceViewAtStart));
		}, u = () => {
			if (Zt.current.size === 1) {
				let [e, t] = [...Zt.current.entries()][0];
				sn.current = 0, cn.current = 0, U.current = ri(e, t.x, t.y);
			} else Zt.current.size === 0 && (U.current = { kind: "idle" });
		}, d = (e) => {
			let i = U.current;
			if (i.kind === "pinch") {
				let t = gi(Zt.current, {
		...
		return document.addEventListener("pointermove", d), document.addEventListener("pointerup", f), document.addEventListener("pointercancel", p), () => {
			document.removeEventListener("pointermove", d), document.removeEventListener("pointerup", f), document.removeEventListener("pointercancel", p), on.current != null && (cancelAnimationFrame(on.current), on.current = null), ln.current != null && (cancelAnimationFrame(ln.current), ln.current = null);
		};
	}, [
		z,
		gt,
		...
		let e = O.select(Ue.current);
		e.selectAll("*").remove();
		let t = e.append("g").attr("transform", `translate(${$.left},${$.top})`);
		pn.current = t;
		let n = t.append("defs");
		hn.current = n.append("clipPath").attr("id", "chart-viewport").append("rect").attr("x", 0).attr("y", -$.top), Hn.current = n.append("clipPath").attr("id", "chart-price-viewport").append("rect").attr("x", 0).attr("y", -$.top);
		let r = I.current?.resolve(R.background.topColor) ?? "#888888", i = I.current?.resolve(R.background.bottomColor) ?? "#888888", a = n.append("linearGradient").attr("id", "chart-bg-gradient").attr("x1", "0%").attr("y1", "100%").attr("x2", "0%").attr("y2", "0%");
		...
		o.append("stop").attr("offset", "0%").attr("stop-color", r), o.append("stop").attr("offset", "100%").attr("stop-color", i), Un.current = o, mn.current = t.append("rect").attr("x", -$.left).attr("y", -$.top).attr("rx", 12).attr("ry", 12).attr("fill", "transparent"), gn.current = t.append("g").style("font-size", "var(--text-2hxs)").style("font-family", bo).style("font-weight", "500").style("color", "var(--chart-axis-label)"), _n.current = t.append("g").style("font-size", "var(--text-2hxs)").style("font-family", bo).style("font-weight", "500").style("color", "var(--chart-axis-label)").style("display", "none"), vn.current = t.append("g").style("display", "none"), bn.current = t.append("g"), xn.current = t.append("line").attr("y1", -$.top).attr("data-chart-role", "y-axis-border").attr("stroke", "var(--chart-separator)").attr("stroke-opacity", 1), Sn.current = t.append("line").attr("x1", 0).attr("data-chart-role", "x-axis-baseline").attr("stroke", "var(--chart-separator)").attr("stroke-opacity", 1), Kn.current = t.append("g").attr("class", "chart-pattern-overlays-container").node(), qn.current = xa(Kn.current);
		let s = t.append("g").attr("clip-path", "url(#chart-viewport)").append("g");
		Cn.current = s, fn.current = s.node(), wn.current = s.append("g").style("font-size", "var(--text-2hxs)").style("font-family", bo).style("font-weight", "500").style("color", "var(--chart-axis-label)"), Tn.current = t.append("line").attr("stroke", R.crosshair.color).attr("stroke-opacity", R.crosshair.opacity).attr("stroke-dasharray", R.crosshair.dash).attr("y1", 0).style("visibility", "hidden"), En.current = t.append("line").attr("stroke", R.crosshair.color).attr("stroke-opacity", R.crosshair.opacity).attr("stroke-dasharray", R.crosshair.dash).attr("x1", 0).style("visibility", "hidden");
		let c = t.append("text").attr("x", 8).attr("y", 14).style("font-size", "var(--text-sm)").style("font-family", bo).style("font-weight", "500").attr("fill", "currentColor").style("visibility", "hidden");
		Dn.current = c, On.current = [];
		for (let e = 0; e < Oo; e++) On.current.push(c.append("tspan"));
		let l = t.append("g").style("visibility", "hidden");
		Nn.current = l, l.append("rect").attr("width", 56).attr("height", 18).attr("rx", 3).attr("fill", "var(--bg-card)").attr("stroke", "currentColor").attr("stroke-opacity", .2), Pn.current = l.append("text").attr("x", 28).attr("y", 13).attr("text-anchor", "middle").style("font-size", "var(--text-3xs)").style("font-family", bo).style("font-weight", "500").attr("fill", "currentColor");
		let u = t.append("g").style("visibility", "hidden");
		Fn.current = u, u.append("rect").attr("width", vo).attr("height", 18).attr("rx", 3).attr("fill", "var(--bg-card)").attr("stroke", "currentColor").attr("stroke-opacity", .2), In.current = u.append("text").attr("x", vo / 2).attr("y", 13).attr("text-anchor", "middle").style("font-size", "var(--text-3xs)").style("font-family", bo).style("font-weight", "500").attr("fill", "currentColor"), Ln.current = t.append("rect").attr("fill", "transparent"), Rn.current = t.append("rect").attr("fill", "transparent").style("cursor", "ns-resize").style("pointer-events", "all"), Jn.current = t.append("g").attr("class", "chart-drawing-overlays-container").node(), Yn.current = $a(Jn.current);
		let d = t.append("g").attr("class", "trigger-overlays-container").node(), f = t.append("g").attr("class", "trade-overlays-container").node();
		return Lr(d), Fr(f), () => {
			G.current != null && (cancelAnimationFrame(G.current), G.current = null), K.current = null, e.selectAll("*").remove(), pn.current = null, mn.current = null, hn.current = null, gn.current = null, _n.current = null, vn.current = null, bn.current = null, xn.current = null, Sn.current = null, Cn.current = null, fn.current = null, wn.current = null, Tn.current = null, En.current = null, Dn.current = null, On.current = [], Nn.current = null, Pn.current = null, Fn.current = null, In.current = null, Ln.current = null, Rn.current = null, Hn.current = null, Un.current = null, Lr(null), Fr(null), qn.current?.destroy(), qn.current = null, Kn.current = null, Yn.current?.destroy(), Yn.current = null, Jn.current = null;
		};
	}, []), i(() => {
		if (!e || !V || !Ue.current || !pn.current || !Cn.current) return;
		...
		O.select(Ue.current).attr("width", L).attr("height", d), mn.current.attr("width", L).attr("height", i + $.top + $.bottom);
		let f = i + $.top + $.bottom, p = I.current?.resolve(R.background.topColor) ?? "#888888", m = I.current?.resolve(R.background.bottomColor) ?? "#888888";
		Un.current.attr("x1", 0).attr("y1", -$.top).attr("x2", 0).attr("y2", -$.top + f), Un.current.selectAll("stop").attr("stop-color", function() {
			return this.getAttribute("offset") === "0%" ? p : m;
		}), hn.current.attr("width", o - Do).attr("height", i + $.top + $.bottom), Hn.current.attr("width", o - Do).attr("height", $.top + r);
		let h = wi({
			dateAt: (t) => e[t].date,
			from: t,
			to: n,
		...
		gn.current.attr("transform", `translate(${o},0)`);
		let v = [];
		for (let e of a) v.push(e.top);
		a.length > 0 && v.push(i), bn.current.selectAll("line").data(v).join("line").attr("x1", 0).attr("x2", o).attr("y1", (e) => e).attr("y2", (e) => e).attr("stroke", "var(--chart-separator)").attr("stroke-opacity", 1), xn.current.attr("x1", o).attr("x2", o).attr("y2", i), Sn.current.attr("x1", 0).attr("x2", o).attr("y1", i).attr("y2", i), Cn.current.attr("transform", `translate(${c},0)`), wn.current.attr("transform", `translate(0,${i})`).call(O.axisBottom(l).tickValues(g).tickSize(R.axis.tickSize).tickFormat((e) => _.get(e) ?? "")), wn.current.select(".domain").remove(), wn.current.selectAll("line").attr("stroke", ko).attr("stroke-opacity", R.axis.opacity), Tn.current.attr("y2", i), En.current.attr("x2", o), Ln.current.attr("width", o).attr("height", i), Bn.current = r, Rn.current.attr("x", o).attr("y", 0).attr("width", $.right).attr("height", i);
	}, [
		V,
		L,
		e,
		...
		if (zt) [v, y] = zt;
			...
			if (ee === "priceAndOverlays") {
				for (let { config: t, series: a } of H) {
					let o = W(t.defKey);
					if (!o || typeof o.pane == "object" || ne.includes(t.defKey)) continue;
			...
			if (f <= 0) v = Math.exp(u) * .99, y = Math.exp(d) * 1.01;
				...
				let e = s - xo, t = f / Math.max(1, e - 2 * So);
				v = Math.exp(u - So * t), y = Math.exp(d + So * t);
			}
		}
		let b = O.scaleLog().domain([Math.max(1, v), y]).range([s, xo]), [x, S] = b.domain(), C = Math.log(x), w = Math.log(S), E = (e, t) => {
			if (e <= 0) return e;
			let n = 10 ** (Math.floor(Math.log10(e)) - (t - 1));
			return Math.round(e / n) * n;
		}, D = Array.from(new Set(O.range(jo).map((e) => {
			let t = Math.exp(C + e / (jo - 1) * (w - C));
			return E(t, t >= 100 ? 3 : 2);
		}))).sort((e, t) => e - t).slice(0, -1), te = O.format(",.1f");
		gn.current.call(O.axisRight(b).tickValues(D).tickSize(R.axis.tickSize).tickFormat((e) => te(Number(e)))), gn.current.select(".domain").remove(), gn.current.selectAll("line").attr("stroke", ko).attr("stroke-opacity", R.axis.opacity);
		let re = /* @__PURE__ */ new Map(), ie = /* @__PURE__ */ new Map(), ae = /* @__PURE__ */ new Map();
		for (let e of H) {
			let t = W(e.config.defKey), n = t?.pane;
			if (!n || typeof n != "object" || !("subpane" in n)) continue;
			ie.has(n.subpane) || ie.set(n.subpane, t?.domain?.(e.series, e.config.settings) ?? void 0);
			let r = ae.get(n.subpane) ?? [];
			r.push(e), ae.set(n.subpane, r);
		}
		for (let e of l) {
			let t = ie.get(e.key), i = [];
			for (let t of ae.get(e.key) ?? []) {
				let e = W(t.config.defKey)?.autofitKeys?.(t.config.settings) ?? [];
				for (let n of e) {
					let e = t.series[n];
					e && i.push({
						values: e,
			...
			if (a) {
				...
				i > 0 && o > i && r > n && (r = n + (r - n) * (o / (o - i))), re.set(e.key, O.scaleLinear().domain([n, r]).range([e.bottom, e.top]));
			}
		}
		if (_n.current.selectAll("*").remove(), vn.current.selectAll("*").remove(), re.size > 0) {
			_n.current.style("display", null), vn.current.style("display", null);
			let e = O.format(".2~f");
			for (let t of l) {
				let n = re.get(t.key);
				if (!n) continue;
				let r = ie.get(t.key);
				if (!r?.hideAxis) {
					let t = r?.tickFormat ?? e, i = _n.current.append("g").attr("transform", `translate(${d},0)`);
					i.call(O.axisRight(n).ticks(3).tickSize(R.axis.tickSize).tickFormat((e) => t(Number(e)))), i.select(".domain").remove(), i.selectAll("line").attr("stroke", ko).attr("stroke-opacity", R.axis.opacity);
				}
				let i = [...r?.guideLines ?? []];
				r?.zeroLine && i.push(0);
				for (let e of i) vn.current.append("line").attr("x1", 0).attr("x2", d).attr("y1", n(e)).attr("y2", n(e)).attr("stroke", "var(--subpane-guide)").attr("stroke-opacity", .4).attr("stroke-dasharray", "3,3");
			}
		} else _n.current.style("display", "none"), vn.current.style("display", "none");
		let oe = dn() ? z.baseTranslateX : h;
		z.data = e, z.subpaneScales = re, z.xScale = f, z.yPrice = b, z.step = m, z.bandwidth = p, z.visibleBars = B, z.visibleBarsInt = g, z.visibleStartIdx = _, z.maxVisibleBars = Et, z.priceHeight = s, z.width = d, z.baseTranslateX = oe, z.dataLength = e.length, z.indicators = H, sr.current = {
			fullHeight: c,
			bands: l
		}, gt("rescale"), qn.current?.updateScales({
			xScale: f,
			yPrice: b,
			step: m,
			bandwidth: p,
		...
		let se = (e) => I.current?.resolve(e) ?? "#888888";
		kt.current = {
			cssWidth: L,
			...
			data: e,
			colors: {
				positive: se("var(--candle-up)"),
				negative: se("var(--candle-down)")
			},
			background: {
				topColor: se(R.background.topColor),
				bottomColor: se(R.background.bottomColor),
				radius: R.background.radius
			},
			candle: R.candle,
			indicators: H
		}, Mt(), K.current ? An.current?.() : kn.current?.();
	}, [
		V,
		H,
		zt,
		...
		if (Xe === 0 || !fn.current || L === 0) return;
		let e = ge(S, Xe, B), t = (L - $.left - $.right - Do) / B, n = (e + B - Xe) * t;
		fn.current.setAttribute("transform", `translate(${n},0)`), z.baseTranslateX = n, gt("pan"), qn.current?.setTransform(n), Yn.current?.setTransform(n), Mt();
	}, [
		S,
		B,
		Xe,
	...
	return i(() => {
		...
		let t = (e) => {
			...
			let t = z.data;
			if (t.length === 0) {
				Dn.current?.style("visibility", "hidden");
				return;
			}
			...
			Dn.current.style("visibility", "visible");
		}, r = () => n(z.data.length - 1);
		kn.current = r;
		let i = () => {
			Tn.current?.style("visibility", "hidden"), En.current?.style("visibility", "hidden"), r(), t(null), Nn.current?.style("visibility", "hidden"), Fn.current?.style("visibility", "hidden"), qn.current?.setPointer(null, null);
		};
		jn.current = i;
		let a = () => {
			G.current = null;
			...
			let { data: o, yPrice: s, step: c, bandwidth: l, visibleBarsInt: u, visibleStartIdx: d, priceHeight: f, width: p } = z, m = sr.current.fullHeight;
			if (i < 0 || i > p || a < 0 || a > m) {
				Tn.current.style("visibility", "hidden"), En.current.style("visibility", "hidden"), Nn.current.style("visibility", "hidden"), Fn.current.style("visibility", "hidden");
				return;
			}
			En.current.attr("y1", a).attr("y2", a).style("visibility", "visible");
			let h = Math.floor(i / c), g = h >= 0 && h < u, _ = g ? d + h : -1, v = _ >= 0 && _ < o.length, y = g ? h * c + l / 2 : i;
			if (Tn.current.attr("x1", y).attr("x2", y).style("visibility", "visible"), v ? (n(_), t(_)) : (r(), t(null)), a <= f && i <= p) {
				Nn.current.attr("transform", `translate(${p + yo},${a - 9})`).style("visibility", "visible"), Pn.current.text(vt.current(s.invert(a)));
				let e = v ? o[_].date : Oa(i - z.baseTranslateX, pr()), t = Math.max(0, Math.min(p - vo, y - vo / 2)), n = sr.current.fullHeight + yo;
				Fn.current.attr("transform", `translate(${t},${n})`).style("visibility", "visible"), In.current.text(Ci(e));
			} else Nn.current.style("visibility", "hidden"), Fn.current.style("visibility", "hidden");
		};
		An.current = a, e.on("pointerdown", function(e) {
			if (e.button !== 0 || e.ctrlKey || (e.preventDefault(), z.data.length === 0)) return;
			...
			if (t.mode === "pinch" && (n === "pan" || n === "idle" || n === "pinch")) {
				n === "pan" && ii(), U.current = {
					kind: "pinch",
					pointers: Zt.current,
					prevDist: hi(Zt.current)
				}, jn.current?.();
				return;
			}
			if (!e.isPrimary) return;
			let r = pn.current, [i, a] = r ? O.pointer(e, r.node()) : [0, 0];
			if (q.current !== "cursor") {
				X(i, a);
				return;
			}
			...
			U.current = ri(e.pointerId, e.clientX, e.clientY), sn.current = 0, cn.current = 0;
		});
		let o = Rn.current;
		o?.on("pointerdown", function(e) {
			if (e.button !== 0 || e.ctrlKey || O.pointer(e, this)[1] > Bn.current) return;
			e.preventDefault(), e.stopPropagation(), this.setPointerCapture?.(e.pointerId);
			let t = Vt.current ?? z.yPrice.domain();
			U.current = {
				kind: "yAxis",
				pointerId: e.pointerId,
				startY: e.clientY,
				...
				priceViewAtStart: Vt.current
			}, P.current && (P.current.style.cursor = "ns-resize");
		}), o?.on("dblclick", function(e) {
			O.pointer(e, this)[1] > Bn.current || (e.preventDefault(), e.stopPropagation(), Bt(null));
		}), o?.on("mouseenter", function() {
			Wt(!0);
		}), o?.on("mouseleave", function() {
			Wt(!1);
		}), o?.on("pointermove", function(e) {
			this.style.cursor = O.pointer(e, this)[1] <= Bn.current ? "ns-resize" : "";
		});
		let s = (e, t) => {
			...
			let u = Mn(e - z.baseTranslateX, t, l, At.current, (e) => s(e) + i / 2, r);
			return u ? u.sourceId === "__candles__" ? mt.current ? { kind: "candles" } : null : {
				kind: "indicator",
				id: u.sourceId
			} : null;
		};
		e.on("dblclick", function(e) {
			if (e.preventDefault(), performance.now() - Tr.current < Io) {
				Tr.current = 0;
				return;
			}
			let t = pn.current, [n, r] = t ? O.pointer(e, t.node()) : [0, 0], i = s(n, r);
			i && pt.current(i), i?.kind === "drawing" && lr.current.find((e) => e.id === i.id)?.type === "text" && tr(i.id);
		});
		let c = O.select(Ue.current);
		return c.on("pointermove.crosshair", function(e) {
			if (dn()) return;
			let t = P.current;
			if (U.current.kind === "drawingDrag") return;
			let n = pn.current;
			if (!n) return;
			...
			K.current = {
				mx: r,
				my: i
			}, G.current ??= requestAnimationFrame(a);
		}).on("pointerleave.crosshair", function(e) {
			if (dn()) return;
			U.current.kind !== "drawingDrag" && P.current && (P.current.style.cursor = ""), G.current != null && (cancelAnimationFrame(G.current), G.current = null);
			...
			e.on("pointerdown", null).on("dblclick", null), Rn.current?.on("pointerdown", null).on("dblclick", null).on("mouseenter", null).on("mouseleave", null).on("pointermove", null), c.on("pointermove.crosshair", null).on("pointerleave.crosshair", null), G.current != null && (cancelAnimationFrame(G.current), G.current = null);
		};
	}, [
		z,
		X,
		...
		className: se ? A.chartWrapperBare : A.chartWrapper,
		ref: P,
		children: /* @__PURE__ */ u("div", {
			className: A.empty,
			children: oe ? /* @__PURE__ */ d(l, { children: [/* @__PURE__ */ u(f, {
				size: 32,
		...
		children: /* @__PURE__ */ u(fo, {
			...
			children: /* @__PURE__ */ u("div", {
				...
				children: /* @__PURE__ */ d("div", {
					ref: He,
					className: se ? A.chartFrameBare : A.chartFrame,
					"data-trade-overlay-anchor": "",
					children: [
						/* @__PURE__ */ u("canvas", {
							ref: We,
							className: A.seriesCanvas,
							"aria-hidden": "true"
						}),
						/* @__PURE__ */ u("svg", {
							ref: Ue,
							className: A.chartSvg
						}),
						V != null && /* @__PURE__ */ u(xr, {
							indicators: E,
							...
							priceFormatter: _t,
							resolveColor: (e) => I.current?.resolve(e) ?? "#888888"
						}),
						V != null && V.subpanes.map((e, t) => {
							let n = $.top + e.top;
							return /* @__PURE__ */ u("div", {
								className: A.subpaneDivider,
								style: {
									top: n - 8 / 2,
									height: 8
								},
								...
								onPointerUp: Lt,
								onPointerCancel: Rt,
								children: /* @__PURE__ */ u("span", { className: A.subpaneDividerLine })
							}, e.key);
						}),
						V != null && Ce !== !1 && Dt && Xe > 0 && /* @__PURE__ */ u(kr, {
							model: Dt,
							size: De,
							pane: {
								left: $.left,
								top: $.top,
								width: V.width,
								height: V.priceHeight
							},
							position: ur,
							onPositionChange: Ee
						}),
						V != null && Oe && Ot && Xe > 0 && /* @__PURE__ */ u(Ur, {
							model: Ot,
							size: De,
							pane: {
								left: $.left,
						...
						V != null && j && ze && /* @__PURE__ */ u(Er, {
							activeTool: Re,
							onToolChange: ze,
							drawingCount: Ie?.length ?? 0,
							onDeleteAll: Le ? () => Le([]) : void 0,
							pane: {
								left: $.left,
								top: $.top,
								width: V.width,
						...
						Nt > 0 && /* @__PURE__ */ u("button", {
							type: "button",
							"data-chart-native-menu": "",
							className: `${A.resetPanBtn} ${S === 0 ? A.resetPanBtnInactive : ""}`,
							title: "Reset pan",
							onClick: () => w(0),
							disabled: S === 0,
							style: {
						...
						Nt > 0 && Xt && /* @__PURE__ */ u("button", {
							type: "button",
							ref: Yt,
							"data-chart-native-menu": "",
							className: `${A.autoFitBtn} ${Ht ? A.autoFitBtnActive : ""}`,
							title: Ht ? ee === "priceAndOverlays" ? "Auto-fit: price + overlays (click for price-only)" : "Auto-fit: price-only (click to include overlays)" : "Auto-fit price scale (off — drag y-axis to enable)",
							onClick: () => {
								if (Jt(!1), !Ht) {
									Bt(null);
									return;
								}
								te(ee === "priceAndOverlays" ? "price" : "priceAndOverlays");
							},
							onContextMenu: (e) => {
								e.preventDefault(), ee === "priceAndOverlays" && Ht && Jt((e) => !e);
							},
							onMouseEnter: () => Kt(!0),
							onMouseLeave: () => Kt(!1),
							style: {
								bottom: $.bottom + 2,
								right: $.right - 26,
								color: Ht && ee === "priceAndOverlays" ? "#22c55e" : void 0
							},
							children: "A"
						}),
						qt && ee === "priceAndOverlays" && Ht && /* @__PURE__ */ u(Cr, {
							contributors: Gr,
							excluded: ne,
							onExcludedChange: re,
							triggerRef: Yt,
						...
						lt?.kind === "candles" && Fe && /* @__PURE__ */ u(Sr, {
							appearance: Pe ?? {},
							onAppearanceChange: Fe,
							resolveColor: (e) => I.current?.resolve(e) ?? "#888888",
							onClose: ft,
							className: A.centeredPanel
						}),
						Or && (() => {
							let e = W(Or.defKey);
						...
						Le && Dr && /* @__PURE__ */ u(no, {
							...
							onChange: (e) => br(e),
							onDelete: () => {
								Le(cr.filter((e) => e.id !== Dr.id)), Y(null), ft();
							},
							resolveColor: (e) => I.current?.resolve(e) ?? "#888888",
							onClose: ft,
							className: A.centeredPanel
...
//#endregion
export { In as APPEARANCE_DEFAULTS, Dn as CANDLE_SOURCE, Vo as Chart, $n as ChartControls, de as DEFAULT_BARS_PER_YEAR, ie as DEFAULT_RANGE_MARKS, Hn as DRAWING_DEFAULTS, kn as FILLED_HIT_PAD, Ue as LINE_STYLE_OPTIONS, ae as MIN_BAR_STEP_PX, re as MIN_MARK_BARS, oe as MIN_VISIBLE_BARS, vn as OVERLAY_ORDER, Ce as PATTERN_CATALOG, we as PATTERN_NAMES, ee as RANGES, te as RANGE_DAYS, ne as RANGE_YEARS, On as REGION_HIT_TOLERANCE, yn as SUBPANE_ORDER, mr as SettingsDialog, gr as ZoomSlider, k as barIndexForDate, Re as barIndexForDateProjected, fe as barsPerYear, Ut as computeAdx, Ht as computeAtr, Vt as computeDx, Ye as computeEMA, Xe as computeExpandingMax, L as computeRollingHigh, Se as computeVolumeStats, We as dashFor, Ne as dateForBarIndex, ze as dateForBarIndexProjected, hn as defaultConfigFor, jt as dema, zn as effectiveAppearance, Un as effectiveDrawingStyle, kt as emaTalib, _n as formatIndicatorParams, ve as formatPrice, ye as formatVolume, be as formatVolumeTick, W as getIndicator, F as lineStyleFrom, fn as listIndicators, Nt as maDispatch, me as maxVisibleBarsForWidth, Vn as normalizeDrawing, Ae as normalizeStatsPosition, Ho as panButtonClass, Mn as pickHitRegion, pe as rangeMarks, Wt as rawStochK, dn as registerIndicator, Lt as rollingMax, Rt as rollingMin, Bt as rsi, Dt as sma, Gt as stddevPop, Mt as tema, zt as trueRange, _o as useBackgroundPointerDown, ho as useChartGeometry, mo as useChartOverlayHost, lo as useChartScale, go as useReportOverlayPriceBounds, Ft as wilderSmooth, It as wilderSum, Ot as wma };
